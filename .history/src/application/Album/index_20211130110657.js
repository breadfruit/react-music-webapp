...
import {getMoreMusicPlayerRequest} from '../../api/request'
function Album(props) {
  ...
  // useEffect(() => {
  //   console.log('currentAlbum.songids-----', currentAlbumJS.songids)
  //   getMoreMusicPlayerRequest(currentAlbumJS.songids).then(res => {
  //     console.log('获取多个播放歌曲链接', res)
  //   })
  // })
