...
import { getOneMusicPlayerRequest } from '../../api/request'
...
const SongsList = React.forwardRef((props, refs)=> {
  ...
  const selectItem = (e, index) => {
    ...
    let cursong = songs[index].ksong.mid;
    //先获取歌曲播放链接
    setCurrentMusicPlayer(getOneMusicPlayerRequest(cursong).then(res => {
      console.log('获取歌曲播放链接--'+ res)
    }))
    //修改当前播放歌曲
